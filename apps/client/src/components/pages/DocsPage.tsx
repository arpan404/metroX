...
const systemNodes = [
    ...
    { name: 'Domain Packages', role: 'Pipeline · Runtime · Agents · Stats · Security' },
...
const apiGroups = [
    ...
    },
    {
        ...
        routes: [
            ...
            { method: 'GET', path: '/v1/runs/{id}/detector-votes', desc: 'Raw detector votes with attack_type metadata' },
            { method: 'GET', path: '/v1/runs/{id}/detector-votes-summary', desc: 'Scoped detector aggregates + consensus + raw sample' },
        ],
    },
    {
...
const groundingMap = [
    { label: 'Orchestration', path: 'app/pipeline/orchestrator.py' },
    { label: 'API + streaming', path: 'app/api/v1.py' },
    { label: 'Queue + worker', path: 'app/runtime/run_queue.py · app/worker.py' },
    { label: 'Adapters + policy', path: 'app/runtime/adapters.py · app/runtime/policy.py' },
    { label: 'Benchmark + agentic', path: 'app/pipeline/benchmark.py · app/agents/agentic_attacking.py' },
    { label: 'Detection', path: 'app/stats/detection.py' },
    { label: 'Scoring', path: 'app/stats/scoring.py' },
    { label: 'Risk + analytics', path: 'app/stats/risk.py · app/stats/advanced_analytics.py' },
    { label: 'Drift', path: 'app/stats/drift.py' },
    { label: 'Costing', path: 'app/pipeline/costing.py' },
    { label: 'Security', path: 'app/security/service.py' },
    { label: 'Providers', path: 'app/runtime/providers.py' },
    { label: 'Compare + Mitigation', path: 'app/pipeline/compare.py · app/pipeline/mitigation.py' },
    { label: 'Reporting', path: 'app/pipeline/reporting.py' },
